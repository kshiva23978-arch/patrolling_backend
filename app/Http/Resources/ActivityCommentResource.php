...
/** See {@see PatrolEntryCommentResource} — identical shape, for the Activity module. */
class ActivityCommentResource extends JsonResource
{
    ...
    {
        $authorType = $this->atc_admin_id !== null ? 'admin' : 'ranger';
        ...
        $isMine = $authorType === 'ranger'
            ...
            && $this->atc_user_id === $requester->u_id;
        ...
        return [
            ...
            'is_mine' => $isMine,
            'created_at' => $this->atc_created_at?->toISOString(),
            'updated_at' => $this->atc_updated_at?->toISOString(),
        ];
    }
}
